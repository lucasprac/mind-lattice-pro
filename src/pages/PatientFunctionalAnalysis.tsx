...
import { ArrowLeft, Save, Lock, Grid3x3 } from "lucide-react";
...
const PatientFunctionalAnalysis = () => {
  ...
  // Build flat list of processes with their assigned mediators/dimensions from step 3
  ...
  Object.entries(mediatorProcesses).forEach(([dimension, mediators]) => {
    Object.entries(mediators).forEach(([mediator, processes]) => {
      processes.forEach(process => {
        processesWithMediators.push({ process, dimension, mediator });
      });
    });
  });
